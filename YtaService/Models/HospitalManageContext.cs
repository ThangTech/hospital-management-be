...
public partial class HospitalManageContext : DbContext
{
    ...
    public virtual DbSet<YTa> Yta { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Audit_Ho__3214EC07B4231A7E");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HoSoBenh__3214EC0792DAFF72");
            ...
            entity.HasOne(d => d.BacSiPhuTrach).WithMany(p => p.HoSoBenhAns)
                ...
                .HasConstraintName("FK__HoSoBenhA__BacSi__3587F3E0");

            entity.HasOne(d => d.NhapVien).WithMany(p => p.HoSoBenhAns)
                .HasForeignKey(d => d.NhapVienId)
                .HasConstraintName("FK__HoSoBenhA__NhapV__339FAB6E");
        });
        ...
        modelBuilder.Entity<NhapVien>(entity =>
        {
            ...
            entity.HasOne(d => d.Giuong).WithMany(p => p.NhapViens)
                ...
                .HasConstraintName("FK__NhapVien__Giuong__2CF2ADDF");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__YTa__3214EC07AE68438D");
