...
namespace BacSiService.DAL.Helper
{
    // Đã đổi tên class này từ CollectionHelper -> MessageConvert
    public static class MessageConvert
    {
        private static readonly JsonSerializerSettings Settings;

        // Static constructor phải trùng tên với class
    ...
    // Class này giữ nguyên tên là CollectionHelper
                ...
                foreach (DataColumn column in row.Table.Columns)
                {
                    ...
                    try
                    {
                        ...
                        if (value != DBNull.Value)
                        {
                            ...
                            {
                                // Ở đây gọi MessageConvert sẽ không bị lỗi nữa
